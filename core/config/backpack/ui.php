...
return [
    ...
    //
    // Eg. If you're using.theme-coreuiv4 and config/backpack.theme-coreuiv4.php
    ...
    */
    ...
    | (eg. config/backpack.theme-coreuiv4.php) when that theme is in use.
    |
    */
    ...
    'project_logo' => '<img src="/assets/images/logo-white.png" style="width: 200px;" class="mb-1" />',
