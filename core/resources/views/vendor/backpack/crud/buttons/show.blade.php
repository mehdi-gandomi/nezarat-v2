...
@if ($crud->hasAccess('show', $entry))
	...
	<a href="{{ url($crud->route.'/'.$entry->getKey().'/show') }}" class="btn btn-sm btn-link">
		<span><i class="la la-eye"></i> {{ $crud->entity_name == "دفتر" ? "ثبت صورتجلسه":trans('backpack::crud.preview') }}</span>
	</a>
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu dropdown-menu-right">
  	    <li class="dropdown-header">{{ $crud->entity_name == "دفتر" ? "ثبت صورتجلسه":trans('backpack::crud.preview') }}:</li>
